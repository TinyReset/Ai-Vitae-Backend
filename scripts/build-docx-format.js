// Build DOCX Format Requests
// Same CV formatting as Chain 1 but text source is Format CV for Doc
const documentId = $json.documentId;
let text = '';
try { text = $('Format CV for Doc').first().json.formattedCVText; } catch(e) {}
if (!text) try { text = $('Stash Context').first().json.cvRewriteText; } catch(e) {}
if (!documentId || !text) {

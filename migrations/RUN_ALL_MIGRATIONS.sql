-- =============================================================================
-- MASTER MIGRATION SCRIPT - Run All Database Security Audit Changes
-- =============================================================================
-- Project: Ai-Vitae
-- Created: 2026-01-18
...
CREATE INDEX IF NOT EXISTS idx_audit_log_retention ON public.audit_log(occurred_at) WHERE occurred_at < NOW() - INTERVAL '365 days';
